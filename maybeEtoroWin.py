    ...
    for activo in frombd:
          ...
          for activoEnWeb in actividad:
            if(activo['InstrumentID']==activoEnWeb['InstrumentID']):
               ...
               if(diferencia <0):
                       existe=0
                       print("se vendio " + str(diferencia) + activoEnWeb['InstrumentID'])
               ...
               if(diferencia >0):
                       existe=0
                       print("se compro " + str(diferencia) + activoEnWeb['InstrumentID'])
...
for id in investors:
    ...
    if (existe == 1):
     crearNotificaciones(activityFromBD,json.dumps(datajsonUsr),"name")
