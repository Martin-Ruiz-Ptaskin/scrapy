...
if ($data === null) {
    ...
    $query = "INSERT INTO `activosenoperaciones` 
              ( `activo`, `operador`,`cantidad`,`value`,`movimiento`,`tipo_investor`,`own`,`position`) 
              VALUES ('$code', '$insider', '$QTY', '$value', '$operacion', 'insider', '$own', '$title')";
